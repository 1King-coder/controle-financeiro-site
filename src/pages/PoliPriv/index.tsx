...
export default function PoliPriv(): JSX.Element {
  return (
    <Container>
      <h2><span style={{ color: 'rgb(68, 68, 68)' }}>Política Privacidade</span></h2>
      <p><span style={{ color: 'rgb(68, 68, 68)' }}>A sua privacidade é importante para nós. É política do Controle financeiro Vsbdev respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="https://ctrl-fin.vsbdev.com.br">Controle financeiro Vsbdev</a>, e outros sites que possuímos e operamos.</span></p>
      ...
      <p><span style={{ color: 'rgb(68, 68, 68)' }}>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Controle financeiro Vsbdev oferece no site e com caráter enunciativo, mas não limitativo:</span></p>
      <ul>
        ...
        <li><span style={{ color: 'rgb(68, 68, 68)' }}>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Controle financeiro Vsbdev, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</span></li>
      </ul>
      ...
      <p><span style={{ color: 'rgb(68, 68, 68)' }}>Esta política é efetiva a partir de&nbsp;16 January 2026 23:38</span></p>
    </Container>
  );
}